...
contract CoverageTest is BaseTest {
    function testOtherFunctions() public {
        ...
        MeMe1ERC20WithSupply linear = MeMe1ERC20WithSupply(factory.deployToken(info, 100 ether));
        ...
        fakeUSDT.approve(address(factory), type(uint256).max);
        linear = MeMe1ERC20WithSupply(factory.deployToken(info, 100 ether));
    }
}
