...
contract AccessControlTest is BaseTest {
    ...
    function testFactoryRole() public {
        ...
        vm.expectRevert();
        IMeMe1Factory.TokenInfo memory token = IMeMe1Factory.TokenInfo({
            tokenType: "",
            bondingCurveType: "",
        ...
        MeMe1ERC20Mixed newErc20 = new MeMe1ERC20Mixed();
        vm.expectRevert();
        factory.updateBondingImplement("ERC20", address(newErc20));
