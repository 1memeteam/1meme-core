...
// diy
import "../abstract/MeMe1Base.sol";

contract MeMe1ERC20Mixed is MeMe1Base, ERC20VotesUpgradeable {
    function initialize(address bondingCurveAddress, IMeMe1Factory.TokenInfo memory token, address factory) public virtual override initializer {
