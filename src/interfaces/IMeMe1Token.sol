...
import "./IMeMe1Factory.sol";

/**
 * @dev Interface of the Bonding swap
 */
interface IMeMe1Token is IAccessControlUpgradeable {
    /**
     * @dev Initializes the Bonding token contract.
     * @param bondingCurveAddress Address of the bonding curve contract.
     * @param token the parameters of token.
     * @param factory Address of the factory contract.
     */
    function initialize(address bondingCurveAddress, IMeMe1Factory.TokenInfo memory token, address factory) external;
